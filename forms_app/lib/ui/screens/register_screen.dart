...
import 'package:forms_app/ui/blocs/register_cubit/register_cubit.dart';
import 'package:forms_app/ui/widgets/forms/inputs.dart';
...
class _RegisterView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /**
     * Para formularios usar SafeArea
     */
    return SafeArea(
      child: Padding(
    ...
    return Form(
      child: Column(
        children: [
          ...
          CustomTextFormField(
            label: 'Email',
            iconData: Icons.wrap_text_sharp,
